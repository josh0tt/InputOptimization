...
# Assuming these functions are adapted to be async or wrapped to work asynchronously
include("helpers.jl")
...
function main()
    ...
    # Load data
    safe_bounds, times, Z_t, titles, scaler, n, m, t = load_human_flown_data(safe_bounds, include_forces)
    ...
    _, _, _, _ = plan_control_inputs(safe_bounds, times, Z_t, scaler, start_time, t0, t_horizon, n, m, t)
    ...
    replan_task = Threads.@spawn plan_trajectory(shared_data, safe_bounds, scaler, t_horizon, n, m, t)
