...
function run_f16_ground_truth_waypoint_sim(step=1/15, gif=false)
    pushfirst!(PyVector(pyimport("sys")."path"), joinpath(@__DIR__, ".."))
    ...
    def simulate(step, gif):
        ...
        waypoints = [[e_pt, n_pt + 5000, h_pt + 1000],
                     ...
                     [e_pt + 50000, n_pt + 40000, h_pt-1000],
                     [e_pt + 70000, n_pt + 40000, h_pt],
                     [e_pt + 60000, n_pt + 60000, h_pt],
                     [e_pt + 60000, n_pt + 40000, h_pt],
                     [e_pt + 50000, n_pt + 40000, h_pt-1000],
                        [e_pt + 40000, n_pt + 45000, h_pt],
                        [e_pt + 30000, n_pt + 40000, h_pt+1000],
                        [e_pt + 20000, n_pt + 40000, h_pt],
                        [e_pt + 10000, n_pt + 40000, h_pt],
                        [e_pt, n_pt + 60000, h_pt],
                        [e_pt, n_pt + 40000, h_pt],
                        [e_pt + 2000, n_pt + 35000, h_pt - 1000],
                        # [e_pt, n_pt + 30000, h_pt],
                        [e_pt - 2000, n_pt + 25000, h_pt + 1000],
                        [e_pt, n_pt + 20000, h_pt],
                        # [e_pt + 2000, n_pt + 15000, h_pt - 1000],
                        [e_pt, n_pt + 10000, h_pt],
                        # [e_pt - 2000, n_pt + 5000, h_pt + 1000], 
                        [e_pt+40000, n_pt+40000, h_pt+2000]
                     ]
